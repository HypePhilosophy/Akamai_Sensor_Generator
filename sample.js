var _cf = _cf || [],
    bmak = bmak || {
        ...
        cma: function (a, t) {
             ...
             */
            try {
                if (1 == t && bmak.mme_cnt < 100 || 1 != t && bmak.mduce_cnt < 75) {
                    ...
                    var r = bmak.gf(m),
                        ...
                        /*
                        t: mouse event
                        i: Date comparison (timestamp related)
        ...
        cta: function (a, t) {
            ...
            */
            ...
            try {
                if (1 == t && bmak.tme_cnt < 25 || 1 != t && bmak.tduce_cnt < 25) {
                    var e = a || window.event,
                        n = -1,
                        o = -1;
                    e && e.pageX && e.pageY ? (n = Math.floor(e.pageX), o = Math.floor(e.pageY)) : e && e.clientX && e.clientY && (n = Math.floor(e.clientX), o = Math.floor(e.clientY));
        ...
        cdoa: function (a) {
            //Device orientation
            try {
                if (bmak.doe_cnt < 10 && bmak.doa_throttle < 2 && a) {
        ...
        cdma: function (a) {
            ...
            try {
                if (bmak.dme_cnt < 10 && bmak.dma_throttle < 2 && a) {
                    var t = bmak.get_cf_date() - bmak.start_ts,
                        e = -1,
                        n = -1,
                        o = -1;
        ...
        check_stop_protocol: function () {
            var a = bmak.get_stop_signals(),
                t = a[0];
            !bmak.rst && t > -1 && (bmak.ir(), bmak.rst = true);
            var e = a[1];
        ...
        listFunctions: {
            ...
            _setBm: function (a) {
                bmak.bm = a, bmak.bm ? (bmak.cf_url = (bmak.fsp ? "https:" : document.location.protocol) + "//" + document.location.hostname + "/_bm/_data", bmak.js_post = true) : bmak.params_url = (bmak.fsp ? "https:" : document.location.protocol) + "//" + document.location.hostname + "/get_params"
            },
            _setAu: function (a) {
